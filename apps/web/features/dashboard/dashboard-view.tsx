...
import { DataStatusNotice } from "@/features/dashboard/components/data-status-notice";
import { formatTimelineMeta } from "@/features/dashboard/dashboard-formatters";
import {
  defaultModulePresentation,
  fallbackModules,
  modulePresentation,
} from "@/features/dashboard/dashboard-presentation";
import type { DashboardLoadState } from "@/features/dashboard/types";
